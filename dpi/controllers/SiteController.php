...
use dpi\forms\LoginForm;
use dpi\forms\PasswordResetRequestForm;
use dpi\forms\ResetPasswordForm;
use dpi\forms\SignupForm;
use dpi\forms\ContactForm;

/**
 * Class SiteController
 * @package dpi\controllers
