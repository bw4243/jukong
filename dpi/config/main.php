...
return [
    ...
    'bootstrap' => ['log'],
    'controllerNamespace' => 'dpi\controllers',
    // 'catchAll' => ['site/offline'], // 全拦截路由(比如维护时可用)
    'modules' => [
        /** ------ 会员模块 ------ **/
        'member' => [
            'class' => 'dpi\modules\member\Module',
        ],
        /** ------ 开放平台模块 ------ **/
        'open' => [
            'class' => 'dpi\modules\open\Module',
        ],
    ],
    'components' => [
        'request' => [
        ...
        'user' => [
            ...
            'identityCookie' => ['name' => '_identity-dpi', 'httpOnly' => true],
            'loginUrl' => ['site/login'],
            'idParam' => '__dpi',
        ],
        'session' => [
            // this is the name of the session cookie used for login on the dpi
            'name' => 'advanced-dpi',
        ],
        'log' => [
